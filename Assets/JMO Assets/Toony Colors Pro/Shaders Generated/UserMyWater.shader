...
Shader "Toony Colors Pro 2/User/MyWater"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		HLSLINCLUDE
			...
			Varyings ShadowDepthPassVertex(Attributes input)
			{
				...
				// Texture Coordinates
				output.pack2.xy.xy = input.texcoord0.xy * _BaseMap_ST.xy + frac(_Time.yy * _BaseMap_SC.xy) + _BaseMap_ST.zw;
				// Shader Properties Sampling
				float __wavesFrequency = ( _WavesFrequency );
				float __wavesHeight = ( _WavesHeight );
				float __wavesSpeed = ( _WavesSpeed );
...
/* TCP_DATA u config(ver:"2.9.2";unity:"2021.3.10f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","SHADOW_COLOR_MAIN_DIR","FOAM_ANIM","RIM","DISABLE_SHADOW_CASTING","DISABLE_ADDITIONAL_LIGHTS","VSW_WORLDPOS","VSW_FOLLOWNORM","SHADER_BLENDING","ALPHA_BLENDING_PREMULT","VERTEX_SIN_WAVES","DEPTH_BUFFER_COLOR","DEPTH_BUFFER_FOAM","DEPTH_BUFFER_ALPHA","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:True;scv:"";scv_lbl:"";gsc:True;roff:False;goff:True;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:True;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_BaseMap";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"b18a2295-a57c-4b4c-9d2b-4237eb03c3a6";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,sp(name:"Blend Operation";imps:list[imp_enum(value_type:1;value:0;enum_type:"ToonyColorsPro.ShaderGenerator.BlendOperation";guid:"c4d7f036-c6ae-48dd-94fc-6bb76e77d548";op:Multiply;lbl:"Blend Operation";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 54abe425c7c686d3f02258d541f6febe */
